...
const _sfc_main$f = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function generate() {
      value.value = [rand(), rand(), rand(), rand()].join(".");
    }
    generate();
    return (_ctx, _cache) => {
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createBlock(RandomsView);
    };
  }
});
...
const _hoisted_2$7 = /* @__PURE__ */ createBaseVNode("h1", null, "This is an about page", -1);
const _hoisted_3$6 = [
  _hoisted_2$7
];
...
const AboutViewVue = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$6]]);
/*!
  * vue-router v4.1.6
